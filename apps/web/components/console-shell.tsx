...
const VIEW_TITLES: Record<ConsoleView, { title: string; subtitle: string }> = {
  overview: {
    title: "Overview",
    subtitle:
      "Track active mandates, autonomous executions, and on-chain proof.",
  },
  automation: {
    title: "Automation",
    subtitle:
      "Run agent strategies through signal, policy, execution, and proof.",
  },
  mandates: {
    title: "Mandates",
    subtitle: "Create, inspect, revoke, and withdraw mandate vaults.",
  },
  activity: {
    title: "Activity Log",
    subtitle:
      "Every execution, block, revocation, and withdrawal recorded on-chain.",
  },
  orders: {
    title: "DeepBook Orders",
    subtitle: "Executed DeepBook swaps generated by Mandate automation.",
  },
};
  ...
  return (
    <MandateStoreProvider>
        ...
        <SidebarInset>
          ...
          <main className="flex-1 overflow-y-auto bg-background">
            <div className="mx-auto w-full max-w-6xl px-4 py-6 md:px-6 md:py-8">
              ...
              {view === "automation" && (
                <AutomationView onSelectMandate={setDetailId} />
              )}
              {view === "mandates" && (
                <MandatesView
                  onSelectMandate={setDetailId}
      ...
      <MandateDetailSheet
        mandateId={detailId}
        startRevokeNonce={
          revokeRequest?.mandateId === detailId
            ? revokeRequest.nonce
            : undefined
        }
